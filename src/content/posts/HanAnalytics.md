...
![[Screenshot 2025-10-18 at 20-04-29 分析和日志 Web Analytics Cloudflare.png]]
...
通过阅读 GitHub 仓库的 [Readme.md](http://Readme.md)，我了解到其作用和[部署教程](https://www.vvhan.com/article/han-analytics)，于是准备尝试。
...
![[/images/e5bb5d834fa4ae78f30849151cd10bef.png]]
...
![[/images/693fc725bd4ee201e909e726858aef22.png]]

进入 Workers 和 Pages 页面后，点击右侧 Account ID 进行复制备用

![[/images/326c1d17e4ac72508154168205fbd34e.png]]
...
![[/images/8736d3b2c0af89f3498f9bd54f0469c3.png]]
![[/images/80cfcaa5f48e8ad80ab3eb089f605b0a.png]]
![[/images/fcee8f37-b259-436d-ad4e-6c9da2ab193e.png]]
### 4. 开启分析引擎
...
![[/images/Pasted image 20251018202650.png]]
![[/images/Pasted image 20251018202904.png]]
### 5. 创建 Pages 项目

登录 Cloudflare，创建 Pages 项目，链接之前 Fork 的 GitHub 仓库。架构选择 Vue，然后填入环境变量，环境变量含义如下,大部分人只需要按图片一样填写二个：
![[/images/Pasted image 20251018203216.png]]
...
![[/images/8ad2647d310002722106f5d5e27c48c6.png]]
...
```
// 在网站底部插入以下代码即可集成网站分析仪表板<script defer src="https://xxxxxx.pages.dev/tracker.min.js" data-website-id="自定义网站唯一标识"></script>
```
